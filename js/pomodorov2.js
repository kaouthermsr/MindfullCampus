...
allBackgroundMusic = {
	harshita: new Howl({
		src: ["assets/sounds/background_music/harshita.mp3"],
		volume: 0.9,
		loop: true,
	}),
	aditiya: new Howl({
		src: ["assets/sounds/background_music/aditiya.mp3"],
		volume: 0.9,
		loop: true,
	}),
	anusha: new Howl({
		src: ["assets/sounds/background_music/anusha.mp3"],
		volume: 0.9,
		loop: true,
	}),
	sourav: new Howl({
		src: ["assets/sounds/background_music/sourav.mp3"],
		volume: 0.9,
		loop: true,
	}),
	yatin: new Howl({
		src: ["assets/sounds/background_music/yatin.mp3"],
		volume: 0.9,
		loop: true,
	}),
};
